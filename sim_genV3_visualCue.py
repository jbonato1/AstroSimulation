...
import pickle
from computeMI import computeMI_par_single_VC2

#
file = open('/home/jbonato/Documents/AstroEncInfo/param_sim_VC_ALL.pkl','rb')
...
#                 pos = np.abs(stimS[i]-centerPF_bin)
            ...
            ########### compute MI
            dict_out = computeMI_par_single_VC2(data,spaceS,Sbins,3)
            if simulation==0:
                dict_gen = dict_out
            else:
                for key in dict_out:
        ...
        #file2 = open('/home/jbonato/Documents/AstroEncInfo/Results/MI_trial'+str(trial)+'_R4_space12_alpha'+str(alpha)+'visual_cue.pkl','wb')
        #pickle.dump(dict_gen,file2)
        #file2.close()
        file2 = open('/home/jbonato/Documents/AstroEncInfo/Results/MI_trial'+str(trial)+'_R3_space12_alpha'+str(alpha)+'visual_cue_all.pkl','wb')
        pickle.dump(dict_gen,file2)
        file2.close()